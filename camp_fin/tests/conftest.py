...
class FakeTestData(object):
    ...
    def races(cls):
        ...
        contribution = TransactionType.objects.create(description='Monetary contribution',
                                                      contribution=True,
                                                      anonymous=False)
        ...
        cls.loan = Loan.objects.create(status=status,
                                       date_added=datetime.datetime.now(pytz.utc),
                                       received_date=datetime.datetime.now(pytz.utc),
                                       filing=cls.first_filing,
                                       amount=33.0)
        ...
        cls.contributions = ((cls.first_contribution, cls.loan),
