...
class PAC(models.Model):
    ...
    email = models.CharField(max_length=50, null=True)
    address = models.ForeignKey("Address", related_name="address", db_constraint=False)
    treasurer = models.ForeignKey("Treasurer", db_constraint=False)
    ...
    bank_address = models.ForeignKey("Address", related_name="bank_address", null=True, db_constraint=False)
